...
class Motor_model{
    ...
    public function getAllMotor(){
        $this->db->query('select M.nama,M.harga,L.nama_kota,T.nama_tipe,B.nama_brand from motor M join brand B on M.id_brand = B.id_brand JOIN lokasi L on M.id_kota = L.id_kota join tipe T on M.id_tipe = T.id_tipe');
        return $this->db->resultSet();
    }
